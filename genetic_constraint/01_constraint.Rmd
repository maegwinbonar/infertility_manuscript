...
Assess constraint using two metrics: LOEUF and lofpLI

using table to constraints from gnomeAD
...
gnomeAD_const <- read.table("/gpfs/gibbs/pi/tucci/pfr8/resources/gnomAD/v4.0.0/gnomad.v4.1.constraint_metrics.tsv", header = TRUE)
head(gnomeAD_const)

## read in table of genes of interest (infertility)
genes_infert <- read.table("/gpfs/gibbs/pi/tucci/mpb63/infertility_2024/infertility_analyses_2025/infertilityGeneList_unique.txt", header = FALSE)
